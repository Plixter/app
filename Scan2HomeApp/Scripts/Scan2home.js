...
xrxTemplateGetTemplateList( "http://"+ip, callback_success_templist, callback_failure_templist, 0 );


 
 
     //xrxTemplateGetTemplate("http://"+ip, templateName, callback_success_template, callback_failure_template, 0);
     ...
     //xrxTemplateDeleteTemplate("http://"+ip, templateName, checksum, callback_success_template, callback_failure_template, 0)
     // xrxScanV2InitiateScanJobWithTemplate("http://"+ip, "7A9C74C6-877C-4DA9-8177-47979442F6BF.xst", false, "", callback_success_scan_job, callback_failure_scan_job, 0, false);

    //alert(jobTicket);
    // xrxScanV2InitiateScanJob("http://"+ip, jobTicket, callback_success_scan_job, callback_failure_scan_job);
}
...
xrxTemplateDeleteTemplate( "http://"+ip, templateName, result[templateName], callback_success_delete, callback_failure_delete, 0 );


}
function callback_failure_templist(request, response)
{
//	 alert("xrxTemplateDeleteTemplateRequest");
xrxTemplateDeleteTemplate( "http://"+ip, templateName, "", callback_success_delete, callback_failure_delete, 0 );
...
//	 alert("callback_success_delete");
     xrxTemplatePutTemplate("http://"+ip, templateName, template, callback_success_template, callback_failure_template, 0);
}
...
//alert("callback_success_template");
    xrxScanV2InitiateScanJobWithTemplate("http://"+ip, templateName, false, "", callback_success_scan_job, callback_failure_scan_job, 0, false);
}
...
//    alert("callback_success_scan_job jobid " + jobId);
    //xrxGetJobDetails("http://"+ip, "Smb", "JobId", jobId, callback_success_job_details, callback_failure_job_details);
    xrxJobMgmtGetJobDetails("http://"+ip, "WorkflowScanning", jobId, callback_success_job_details, callback_failure_job_details);
...
function getSessionInfo() {
    xrxSessionGetSessionInfo("http://"+ip, callback_success_get_session, callback_failure_get_session);
}
