...
function xrxJobMgmtListActiveQueue( url, callback_success, callback_failure, timeout, async ) 
{
	...
	headers[0] = ['Content-Type','multipart/related; type=""; boundary=--MIMEBoundary635101843208985196; start="<0.635101843208985196@example.org>"; start-info="application/soap+xml; charset=utf-8"'];
