...
var acctId = null;
var acctType = null;
var templateName = "AirBusTemplate0001.xst";
...
function startScan2home() {
    ...
    //ColorMode
    var colorVal = document.getElementById('s_Color').value; //blackandwhite
    //Sides 
    var sidesVal = document.getElementById('s_Scanning').value; //onesided
    //InputOrientation
    ...
    var template = "[service xrx_svc_general]\n" +
    " {\n" +
...
function callback_success_scan_job(request, response) {
    ...
    alert("get job details for jobid " + jobId);
...
function callback_failure_job_details(request, response) {
    alert("callback_failure_job_details " + response);
}
